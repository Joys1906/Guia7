class EstudiantesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @estudiante.save
        format.html { redirect_to @estudiante, notice: "Estudiante fue creado exitosamente" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to estudiantes_path, status: :see_other, notice: "Estudiante was successfully destroyed." }
  ...
  private
    ...
    def estudiante_params
      params.require(:estudiante).permit(:nombres, :apellidos, :carrera, :carnet)
    end
end
